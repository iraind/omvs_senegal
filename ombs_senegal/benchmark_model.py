...
# %% auto 0
__all__ = ['normalize', 'FeatureGenerator', 'SimpleRegressionModel', 'plot_benchmark_scores']
...
def plot_benchmark_scores(
    ...
    scatter = ax.scatter(df['mae'], df['mse'])

    for (deg, win), (mae, mse) in zip(df.index, df[['mae', 'mse']].values):
